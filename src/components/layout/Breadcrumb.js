        ...
        <div className="my-2 bg-light d-flex justify-content-between align-items-center">
            <div className="d-flex align-items-center gap-1">
                <div className="mx-2 d-flex align-items-center">
                    <Link href="/" className='text-decoration-none text-black'><BiHome size={28} /></Link>
            ...
            <div className='px-2'>
                <Link href="#" className='text-decoration-none text-black' onClick={() => router.back()}><BiLeftArrowCircle size={28} /></Link>
            </div>
        </div>
    )
}
